...
find /home/perubu/Documents/${GitHubDir}/3.a.1-linux/Linux\ Mint\ 20/ -type f -name ',*.sh' -exec sudo ln -fs {} /usr/local/sbin/ \;
...
ln -fs '/home/perubu/Documents/'"${GitHubDir}"'/3.a.2-vsCode/config/Code/User/tasks.json' '/home/perubu/.config/Code/User/'
